...
public class ExcelUtils {
    ...
    //Excel'deki verileri Test sınıfında kullanmak için bu methodu kullanırız
    ...
    //               Satır ve sütun sayıları girildiğinde o hücredeki veriyi eturn eder
    ...
    //             Excel'deki dataları 2 boyutlu array şeklinde alır
    ...
    //           Değer, Satir ,Sütun girildiğinde o satır ve sütuna girilen veriyi yazdırır
    ...
    // üstteki method ile birlikte çalışır,yardımcısı.sadece parametreleri farklıdır
    public void setCellData(String value, String columnName, int row) {
        int column = getColumnsNames().indexOf(columnName);
        setCellData(value, row, column);
    }

    //Tüm exceldeki dataları başlıksız olarak 2 boyutlu array şeklinde return eder
